...
__attribute__((section(".text"))) int xorCipherOpcodeSize = 55;
__attribute__((section(".text"))) char xorCipherOpcode[] =
...
__attribute__((section(".text"))) int rot128CipherOpcodeSize = 64;
__attribute__((section(".text"))) char rot128CipherOpcode[] =
